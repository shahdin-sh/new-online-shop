...
from .views import home_page, category_detail, product_detail_view, add_to_wishlist
...
urlpatterns = [
    ...
    path('<slug:wished_item_slug>/add_to_wishlist', add_to_wishlist, name='add_to_wishlist')
]